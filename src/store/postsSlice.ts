...
export const fetchPost = createAsyncThunk('app/fetchPost', async (page: number, { rejectWithValue }) => {
  try {
...
export const postPost = createAsyncThunk('app/postPost', async (postData: ArticleData, { rejectWithValue }) => {
  try {
...
export const deletePost = createAsyncThunk('app/deletePost', async (slug: string, { rejectWithValue }) => {
  try {
...
export const editPost = createAsyncThunk('app/editPost', async ({ slug, payload }: any, { rejectWithValue }) => {
  try {
...
export const fetchPostBySlug = createAsyncThunk('posts/fetchPostBySlug', async (slug: string, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://blog.kata.academy/api/articles/${slug}`, {
      method: 'GET',
      headers: {
...
export const postLike = createAsyncThunk('app/postLike', async ({ slug, isLiked }: { slug: string; isLiked: boolean }, { rejectWithValue }) => {
  try {
